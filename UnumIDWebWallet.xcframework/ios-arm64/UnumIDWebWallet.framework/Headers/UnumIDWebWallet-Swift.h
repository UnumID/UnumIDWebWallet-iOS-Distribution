...
#ifndef UNUMIDWEBWALLET_SWIFT_H
#define UNUMIDWEBWALLET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UnumIDWebWallet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15UnumIDWebWallet26UnumIDSafariViewController")
@interface UnumIDSafariViewController : SFSafariViewController
- (void)viewDidLoad;
...
@interface UnumIDSafariViewController (SWIFT_EXTENSION(UnumIDWebWallet)) <SFSafariViewControllerDelegate>
...
SWIFT_CLASS("_TtC15UnumIDWebWallet27WebAuthenticationController")
@interface WebAuthenticationController : NSObject <ASWebAuthenticationPresentationContextProviding>
